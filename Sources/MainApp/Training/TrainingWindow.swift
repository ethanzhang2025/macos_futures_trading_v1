...
struct TrainingWindow: View {
    ...
    private static let helpGroups: [(String, [(String, String)])] = [
        ...
        ("🚀 ControlBar idle 信息密度 (v16.76-177)", [
        ...
        ("📊 ScoreSheet 改进 plan + 快捷键 (v16.147-178)", [
            ...
            ("数字键 1-5 直跳 (v16.168)", "drilldown 跳维度 · 与 ↑↓ 互补"),
        ...
        ("📚 月报增强（v16.118-180）", [
            ("目录 TOC (v16.169)", "10 锚点 · markdown 渲染器自动跳转"),
        ...
        ("📜 HistoryPanel polish (v16.147-179)", [
            ...
            ("grade emoji tooltip (v16.179)", "总分 + 5 维 + violations 速览"),
