...
| E7 | 产品 · 多端与麦语言 | 3 | M7-M8 | 0/3 |
| E8 | 后端与基础设施 | 4 | M1-M6 | 0/4 |
| E9 | 商业化与支付 | 4 | M5-M6 | 0/4 |
| E10 | 品牌与对外物料 | 5 | M1-M6 | 0/5 |
| E11 | GTM · 冷启动 | 4 | M1-M9 | 0/4 |
| E12 | 运维与事故响应 | 5 | M1-M6 | 0/5 |
| E13 | 死亡率自检与风险管理 | 3 | 全周期月度 | 0/3 |
...
- **负责**：你
- **依赖**：无
- **交付**：合规边界纪要（软件提供方定位 / 不下单 Stage A 范围 / 麦语言兼容话术红线 / 用户协议框架）
- **DoD**：1 份律师咨询纪要归档
- **锚点**：D2 §9 Phase 0、D1 §5 话术红线
- **预算**：¥1-3 万
...
- **交付**：《用户协议》《隐私政策》《个保法合规说明》《境内数据存储 + 加密实现说明》、Apple 金融类 App 审核材料
- **DoD**：律师审过 + Apple 审核材料就绪
- **锚点**：D2 §9 Phase 1
...
- **负责**：你
- **依赖**：WP-90 决策
- **交付**：Pro ¥399/年 + ¥39/月订阅配置、沙盒测试、收据验证后端对接
- **DoD**：沙盒环境订阅链路完整 + 后端订阅状态写入正确
- **锚点**：D2 §3 支付通道
...
- **时点**：M1 起每月 standup 时
- **负责**：你 + 合伙人
- **交付**：D3 §7 10 项风险的概率/影响/触发信号月度 review 并更新
...
| 月份 | 必完成 WP |
|------|----------|
| **M1** | WP-01/02/03/04 合规 · WP-10/11/12/13 团队 · WP-20/21/22 PoC · WP-30 Legacy 拷贝 · WP-80 后端骨架 · WP-100 品牌命名 · WP-111 访谈 · WP-120/121 基础设施 · WP-130/131 自检启用 |
...
| **M4** | WP-50 复盘 · WP-51 K 线回放 · WP-52 条件预警 · WP-83 审计日志 · WP-123 status 页启动 |
| **M5** | WP-05 隐私协议 · WP-53 交易日志 · WP-54 模拟训练 · WP-81/82 生产部署 · WP-90 上线决策会 · WP-91 IAP 接入 · WP-102 App Store ASO · WP-113 VIP 群 |
| **M6** | WP-91 IAP 上线 · WP-92 退款流程 · WP-103 少数派第二篇 · **🔴 生死节点：Pro 订阅收钱** |
| **M7** | WP-60 CloudKit UI 同步 · WP-61 iPad 基础版 · Pro 300 目标 |
| **M8** | WP-62 麦语言 30-50 函数 · WP-93 官网微信/支付宝 · Pro 400 目标 |
